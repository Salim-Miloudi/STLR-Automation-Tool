...
* **Pallet verification results**: ![Pallet verification results](./img3.png)
* **Different options to choose from**: ![Different options to choose from](./img2.png)
* **App launching**:  ![App launching](./img4.png)
